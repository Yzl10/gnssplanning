...
function dataParse_alm(alllines) {
    ...
    for (let i = 0; i < lines.length; i += 14) {
        ...
        for (let j = 0; j < line1.length; j++) {
            ...
            if (line1[j] >= 38 && line1[j]<=61){
                let almanace = new Almanac();
                let satellite = new Satellite();
                let index = j
                satellite.prn = 'R'+(line1[index] - 37);
                almanace.prn = 'R'+(line1[index] - 37);
                ...
                satellite.prn = +line1[index] - num;
                almanace.prn = +line1[index] - num;
                almanace.health = +line2[index];
                almanace.e = +line3[index];
                almanace.sqrtA = +line4[index];
                almanace.OMEGA0 = +line5[index] * d2a;
                ...
                almanaces.push(almanace);
                satellites.push(satellite);
            }else if (line1[j] >= 201 && line1[j]<=236){
                let almanace = new Almanac();
                let satellite = new Satellite();
                let index = j
                satellite.prn = 'E'+(line1[index] - 200);
                almanace.prn = 'E'+(line1[index] - 200);
                almanace.health = +line2[index];
                almanace.e = +line3[index];
                almanace.sqrtA = +line4[index];
                almanace.OMEGA0 = +line5[index] * d2a;
                ...
                almanaces.push(almanace);
                satellites.push(satellite);
            }else if (line1[j] >= 1 && line1[j]<=32){
                let almanace = new Almanac();
                let satellite = new Satellite();
                let index = j
                satellite.prn = 'G'+(line1[index]-0);
                almanace.prn = 'G'+(line1[index]-0);
                almanace.health = +line2[index];
                almanace.e = +line3[index];
                almanace.sqrtA = +line4[index];
                almanace.OMEGA0 = +line5[index] * d2a;
